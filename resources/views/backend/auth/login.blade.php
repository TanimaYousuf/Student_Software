...
<head>
    ...
    <!-- Custom Css -->
    <link href="{!! URL::to('public/css_new/css/style.css') !!}" rel="stylesheet">
</head>
...
<body class="login-page">
    <div class="login-box">
        ...
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST" action="{!! URL::to('login.submit') !!}">
                    {!! Form::token() !!}
                    ...
                    <div class="row">
                        <div class="col-xs-8 p-t-5">
                            <a href = "{{route('register')}}">click here for <strong>Register</strong></a>
                        </div>
                        <div class="col-xs-4">
    ...
    <!-- Custom Js -->
    <script src="{!! URL::to('public/js_new/js/admin.js') !!}"></script>
    <script src="{!! URL::to('public/js_new/js/pages/examples/sign-in.js') !!}"></script>
</body>
