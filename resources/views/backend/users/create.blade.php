                        ...
                        <div class="form-row py-4">
                            ...
                            <div class="col-md-6 px-5">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control @error('class') is-invalid @enderror" id="class" value="{{ old('class') }}" name="class">
                                        @error('class')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6 px-5">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control @error('education_year') is-invalid @enderror" id="phone_number" name="education_year" value="{{old('education_year')}}" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="radio-item">
                                            <input type="radio" id="status" name="gender" value="1" checked>
