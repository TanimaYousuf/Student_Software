...
include('https://bikroyit.com/assets/js/jStorage.js', function() {
    include('https://cdn.jsdelivr.net/npm/moment@2.24.0/moment.min.js',function(){
        ...
        if(bikroy_ad_data.no_of_show > ad_visibility_limit){
            ...
            var base_url = window.location.origin + '/' + window.location.pathname.split ('/') [1] + '/public/banners/roadblock.html';
            ...
            var interval = setInterval(function () {
                sec++;
                if(sec > JSON.parse(sessionStorage.getItem("banner")).end_time){
                    ...
                    closeIFrame();
                    clearInterval(interval);
                }else if(sec == JSON.parse(sessionStorage.getItem("banner")).start_time){
                    ...
                    skinBannerHolder.style.backgroundColor = JSON.parse(sessionStorage.getItem("banner")).backgroundColor;
                }
            },1000);
        }
