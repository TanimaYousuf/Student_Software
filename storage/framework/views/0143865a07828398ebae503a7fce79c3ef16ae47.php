...
unset($__errorArgs, $__bag); ?>" id="email" name="email" value="<?php echo e(!empty(old('email')) ? old('email') : $user->email); ?>" autocomplete="nope">
...
unset($__errorArgs, $__bag); ?>" id="address" value="<?php echo e(!empty(old('address')) ? old('address') : $user->address); ?>" name="address">
...
unset($__errorArgs, $__bag); ?>" id="class" value="<?php echo e(!empty(old('class')) ? old('class') : $user->class); ?>" name="class">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control <?php $__errorArgs = ['education_year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="phone_number" name="education_year" value="<?php echo e(!empty(old('education_year')) ? old('education_year') : $user->education_year); ?>" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                        <?php $__errorArgs = ['education_year'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="radio-item">
                                            <input type="radio" id="status" name="gender" value="1" <?php echo e($user->gender == 1 ? 'checked' : ''); ?>>
                                            <label for="status">Male</label>
                                        </div>
                                        <div class="radio-item">
                                            <input type="radio" id="inactive" name="status" value="0" <?php echo e($user->gender == 0 ? 'checked' : ''); ?>>
...
<?php /**PATH C:\xampp\htdocs\student_management_system\resources\views/backend/users/edit.blade.php ENDPATH**/ ?>