...
unset($__errorArgs, $__bag); ?>" id="address" value="<?php echo e(old('address')); ?>" name="address">
...
unset($__errorArgs, $__bag); ?>" id="class" value="<?php echo e(old('class')); ?>" name="class">
...
unset($__errorArgs, $__bag); ?>" id="phone_number" name="education_year" value="<?php echo e(old('education_year')); ?>" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
...
<?php /**PATH C:\xampp\htdocs\student_management_system\resources\views/backend/users/create.blade.php ENDPATH**/ ?>