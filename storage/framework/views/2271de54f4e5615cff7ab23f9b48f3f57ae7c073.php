    ...
    <table class="table supervise-status-table">
        <thead>
            <tr>
                ...
                <th  style="width:25%;">Completed<i class='user-coloumn fas fa-exchange-alt custom-sorting' style="color:#009877;" orderUser="asc" coloumnUser="completed"></th>
                <th  style="width:25%;">Overdue<i class='user-coloumn fas fa-exchange-alt custom-sorting' style="color:#009877;" orderUser="asc" coloumnUser="overdue"></th>
            </tr>
        </thead>
        <tbody>
