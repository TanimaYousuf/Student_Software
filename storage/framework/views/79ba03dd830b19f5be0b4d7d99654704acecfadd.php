        ...
        <div class="col-md-4">
            <div class="Pie-Chart-Card-Box" style="position:relative;">
                <div style="margin-bottom:20px;">
                    <a class="Rectangle-Edit btn-hover2" style="text-decoration: none;" href="<?php echo e(route('users.show', $user->id)); ?>"><i class="fa fa-eye" style="margin-right: 5px;"></i>View</a>
                ...
                <div class="col-md-12 text-center mb-5">
                    <?php if(!empty($user->image) && (file_exists(public_path('backend/uploads/profile_images/'.$user->image)))): ?>
                        <img class="profile-picture" src="<?php echo URL::to('public/backend/uploads/profile_images/'.$user->image); ?>" alt="profile" height="90px;" width="90px" style="border-radius:50%;"/>
                    <?php else: ?>
                ...
                <p style="position:sticky;">Name: <?php echo e($user->name); ?></P>
                <p>Email: <?php echo e($user->email); ?></p>
                <p>Phone Number: <?php echo e($user->phone_number); ?></p>
                <p>Class: <?php echo e($user->class); ?></p>
                <p>Education Year: <?php echo e($user->education_year); ?></p>
...
<?php /**PATH C:\xampp\htdocs\student_management_system\resources\views/backend/users/fetch_user.blade.php ENDPATH**/ ?>