                    ...
                    <div class="row user-info-row">
                        <div class="col-md-12 text-center mb-5">
                            <?php if(!empty($user->image) && (file_exists(public_path('backend/uploads/profile_images/'.$user->image)))): ?>
                                <img class="profile-picture" src="<?php echo URL::to('public/backend/uploads/profile_images/'.$user->image); ?>" alt="profile" height="150px;" width="150px"/>
                            <?php else: ?>
                        ...
                        <div class="col-md-6 user-info-col-2 vl">
                            ...
                            <div class="row profile-info">
                                ...
                                <div class="col-md-8"><?php echo e(empty($user->address) ? '' : $user->address); ?></div>
                            </div>
                            <div class="row profile-info">
                                <div class="col-md-4"><b>Class:</b></div>
                                <div class="col-md-8"><?php echo e(empty($user->class) ? '' : $user->class); ?></div>
                            </div>
                        </div>
                        <div class="col-md-6 user-info-col-3">
                            <div>
                                ...
                                <div class="row profile-info">
                                    ...
                                    <div class="col-md-8"><?php echo e(empty($user->gender) ? '' : $user->gender); ?></div>
                                </div>
                                <div class="row profile-info">
                                    <div class="col-md-4"><b>Education Year:</b></div>
                                    <div class="col-md-8"><?php echo e(empty($user->education_year) ? '' : $user->education_year); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\student_management_system\resources\views/backend/users/profile.blade.php ENDPATH**/ ?>