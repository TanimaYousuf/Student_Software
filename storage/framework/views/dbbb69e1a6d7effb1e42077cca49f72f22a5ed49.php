<table class="table">
    ...
    <tr>
        ...
        <th colspan="3" scope="colgroup">Web</th>
            ...
            <?php $worklogs = \App\Modals\WorkLog::getWorkLogs($user->id,$weekId); ?>
                <?php if(count($worklogs) > 0): ?>
                    <?php for($i=0; $i<$worklogs['maxRow']; $i++): ?>
                        <tr>
                            <?php if($i==0): ?>
                                <td rowspan="<?php echo e($worklogs['maxRow']); ?>"><?php echo e($user->name); ?></td>
                            <?php endif; ?>
                            ...
                            <?php if(isset($worklogs['sunTasks'][$i])): ?>
                                ...
                                <td class="pl-1" style="white-space: pre-line;line-height: 18px;" colspan="2">
                                    <a href="<?php echo e(route('tasks.show',$worklog->Task->id)); ?>" style="color: #009877"><?php echo e(empty($worklog->Task->title) ? '' : $worklog->Task->title); ?><?php echo e(empty($worklog->Task->parent_id) ? '' : ' (Sub-Task)'); ?></a>
                                </td>
                            <?php else: ?>
                                <td colspan="2"></td>
                            <?php endif; ?>
                                ...
                                <td rowspan="<?php echo e($worklogs['maxRow']); ?>">
                                    <?php if($i==0 && count($worklogs['sunTasks']) > 0): ?>
                                        <?php if(\Illuminate\Support\Facades\Auth::user()['id'] == $user->id): ?>
                                            <a class="Rectangle-Delete btn-hover2" style="text-decoration: none;" href="<?php echo e(route('worklogs.edit', $worklog->date)); ?>"><i class="fa fa-pencil" style="margin-right: 5px;"></i></a>
                                        <?php endif; ?>
                                        <?php if(\Illuminate\Support\Facades\Auth::user()['id'] == $user->id): ?>
                                            <a class="Rectangle-Delete btn-hover2" style="text-decoration: none;" href="<?php echo e(route('worklogs.destroy', $worklog->id)); ?>"
                                            onclick="deleteData(<?php echo e($worklog->id); ?>)"><i class="fa fa-trash"></i>
