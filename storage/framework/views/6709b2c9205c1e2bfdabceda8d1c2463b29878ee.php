    ...
    <table class="table supervise-status-table">
        <thead>
            <tr>
                ...
                <th  style="width:25%;">Completed<i class='member-coloumn fas fa-exchange-alt custom-sorting' style="color:#009877;" orderMember="asc" coloumnMember="completed"></th>
                <th  style="width:25%;">Overdue<i class='member-coloumn fas fa-exchange-alt custom-sorting' style="color:#009877;" orderMember="asc" coloumnMember="overdue"></th>
            </tr>
        </thead>
        <tbody>
