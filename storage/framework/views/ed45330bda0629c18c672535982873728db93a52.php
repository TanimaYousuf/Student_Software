                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 task_Status_date_filter">
                                ...
                                <span class='right-inner-addon date datepicker end-date-box' style="float:right;">
                                    ...
                                    <input name='end_date' value="<?php echo e(date('d M, Y',strtotime($end_date))); ?>" data-date="" data-date-format="d M, yyyy" type="text" class="date-picker task-list-filter" placeholder="To" autocomplete="off" id="end_date"/>
